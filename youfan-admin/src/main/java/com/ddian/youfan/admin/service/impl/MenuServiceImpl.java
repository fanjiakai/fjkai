...
import com.ddian.youfan.admin.dao.MenuDao;
import com.ddian.youfan.admin.dao.RoleMenuDao;
...
import com.ddian.youfan.common.dto.RouterDTO;
...
public class MenuServiceImpl implements MenuService {
    ...
    public Tree<MenuDO> getTree() {
        ...
        if (FilterContextHandler.isAdmin()) {
            for (MenuDO menuDO : menuDOs) {
                Tree<MenuDO> tree = new Tree<MenuDO>();
                tree.setId(menuDO.getMenuId().toString());
                tree.setParentId(menuDO.getParentId().toString());
            ...
            List<MenuDO> current = menuMapper.listMenuByUserId(Long.valueOf(FilterContextHandler.getUserID()));
            for (MenuDO menuDO : menuDOs) {
                Tree<MenuDO> tree = new Tree<MenuDO>();
                tree.setId(menuDO.getMenuId().toString());
                tree.setParentId(menuDO.getParentId().toString());
                ...
                for (MenuDO md : current) {
                    if (md.getMenuId().equals(menuDO.getMenuId())) {
                        tree.setDisabled(false);
                        break;
                    }
                }
