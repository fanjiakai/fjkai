...
import com.ddian.youfan.admin.dao.RoleDao;
...
@Service
public class RoleServiceImpl extends DataScopeHelper implements RoleService {
    ...
    public List<RoleDO> list(Map<String, Object> map) {
        map.put("scopeFilter", DataScopeHelper.dataScopeSubFilter(FilterContextHandler.getUserID(),FilterContextHandler.getDeptID(), CommonConstants.DATA_SCOPE_DEPT,"",""));
