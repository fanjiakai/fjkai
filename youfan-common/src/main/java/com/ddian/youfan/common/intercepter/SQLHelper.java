...
public class SQLHelper {
     ...
     * @return 分页SQL
     */
    public static String generatePageSql(String sql, int offset, int limit, Dialect dialect) {
     ...
     * @return 分页SQL
     */
    public static String generatePageSql(String sql, Map<String, Object> page, Dialect dialect) {
        if (dialect.supportsLimit()) {
            return dialect.getLimitString(sql, Integer.parseInt(page.get("offset").toString()), Integer.parseInt(page.get("limit").toString()));
        } else {
            return sql;
        }
    }
